set t_Co=256 "change to use 8 colors only, useful when doing ssh over browser.
colorscheme desert
...
hi Search guibg=#FF0000 cterm=none ctermbg=22
...
hi ColorColumn guibg=#8A8A8A ctermbg=236
